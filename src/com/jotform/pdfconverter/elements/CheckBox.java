...
public class CheckBox
{
    public static void CreateCheckBox(PDAcroForm acroForm ,PDDocument document,PDPage page
       ...
       // document.getDocumentCatalog().setAcroForm(acroForm);
        ...
        PDRectangle rect = new PDRectangle(x, y, width, heigth);
    ...
    {
        File file = new File("radiodd.pdf");

        new PDDocument();
        PDDocument doc = PDDocument.load(file);

        PDAcroForm acroForm = doc.getDocumentCatalog().getAcroForm();
        List<Long> coords = new ArrayList<Long>(Arrays.asList(50L, 50L, 50L,50L));


       // CreateCheckBox( acroForm , doc.getPage(0) , coords);
